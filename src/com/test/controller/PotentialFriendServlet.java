...
/**
 * Servlet implementation class PotentialFriendServlet
 * @author 付豪
 */
@WebServlet("/PotentialFriendServlet")
public class PotentialFriendServlet extends HttpServlet {
